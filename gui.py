...
class LanCheck(ctk.CTk):
    def __init__(self):
        ...
        self.geometry(SETTINGS["main_window_size"])
        ...
        self.label_title = ctk.CTkLabel(
            ...
            font=(SETTINGS["font_family"], 22, "bold")
        )
        ...
        self.desc_label = ctk.CTkLabel(
            ...
            font=(SETTINGS["font_family"], SETTINGS["font_normal_size"]),
            wraplength=460,
            justify="center",
        ...
        self.ip_label = ctk.CTkLabel(
            self.ip_frame, text=f"🌐 {SETTINGS['target_ip']} (localhost)",
            font=(SETTINGS["font_family"], 14, "bold"),
        ...
        self.btn_start = ctk.CTkButton(
            ...
            font=(SETTINGS["font_family"], SETTINGS["font_button_size"], "bold"),
            width=150
        )
        ...
        self.btn_stop = ctk.CTkButton(
            ...
            font=(SETTINGS["font_family"], SETTINGS["font_button_size"]),
            width=100,
            state="disabled",
            fg_color="gray"
        )
        ...
        self.progress = ctk.CTkProgressBar(self, width=SETTINGS["progress_width"])
        self.progress.set(0)

        self.result_text = ctk.CTkTextbox(
            self,
            width=SETTINGS["textbox_width"],
            height=SETTINGS["textbox_height"],
            font=(SETTINGS["font_family"], SETTINGS["font_normal_size"])
        )
        ...
        self.btn_about = ctk.CTkButton(
            self.bottom_frame, text=TEXTS[self.lang]["about_btn"],
            width=100, height=30,
            font=(SETTINGS["font_family"], SETTINGS["font_normal_size"]),
        ...
        self.lang_label = ctk.CTkLabel(
            self.bottom_frame, text=TEXTS[self.lang]["lang_label"],
            font=(SETTINGS["font_family"], SETTINGS["font_normal_size"])
        )
    ...
    def update_ui_texts(self):
        ...
        self.lang_switch.configure(values=["EN"])
        self.lang_switch.set("EN")
    ...
    def scan_ports(self):
        ...
        system_ports = SETTINGS["system_ports"]
